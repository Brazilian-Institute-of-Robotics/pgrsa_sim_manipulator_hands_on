"""
local_pd_controller.py — Controle Local (PD independente por joint)

Estratégia: cada joint é controlado independentemente por um controlador PD.
Usa o action server do JointTrajectoryController para enviar trajetórias.
"""
