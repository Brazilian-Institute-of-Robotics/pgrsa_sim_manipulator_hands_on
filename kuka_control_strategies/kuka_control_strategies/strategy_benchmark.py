...
class StrategyBenchmark(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("duration", 30.0)  # segundos da coleta
        self.declare_parameter("threshold", 0.01)  # rad 
        ...
        self.sub_pd = self.create_subscription(
            ...
            lambda msg: self._cb_error(msg, "local_pd"),
            10,
        )
        ...
        self.sub_ct = self.create_subscription(
            ...
            lambda msg: self._cb_error(msg, "computed_torque"),
            10,
        )
        ...
        self.sub_os = self.create_subscription(
            ...
            lambda msg: self._cb_error(msg, "operational_space"),
            10,
        )
